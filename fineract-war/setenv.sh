...
export FINERACT_HIKARI_JDBC_URL="jdbc:postgresql://fineractmysql:5432/fineract_tenants"
export FINERACT_HIKARI_USERNAME="fineract"
export FINERACT_HIKARI_PASSWORD="fineract"
...
export FINERACT_DEFAULT_TENANTDB_PWD="fineract"
export FINERACT_DEFAULT_TENANTDB_CONN_PARAMS=""
export FINERACT_DEFAULT_TENANTDB_TIMEZONE="Africa/Nairobi"
